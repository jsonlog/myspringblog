(function () {
    ...
    var calendar = {
        ...
        */
        monthTD: {
            "甲": [2, 2],//木 阳 东方木90   丙寅 -.-     -.-     ---雷震[zhèn]      青龙
            "乙": [4, 2],//木 阴 东南方135  戊寅 ---     ---     -.-风巽[xùn]
            "丙": [6, 2],//火 阳 正南方180  庚寅 ---     -.-     ---火离[lí]        朱雀
            "丁": [8, 2],//火 阴 西南方225  壬寅 -.-     -.-太阴  -.-地坤[kūn]
            "戊": [0, 2],//土 阳 正南方     甲寅
            "己": [2, 2],//土 阴 西南方     丙寅
            "庚": [4, 2],//金 阳 正西方270  戊寅 -.-     ---少阴  ---泽兑[duì]       白虎
            "辛": [6, 2],//金 阴 西北方315  庚寅 ---     ---太阳  ---天乾[qián]
            "壬": [8, 2],//水 阳 正北方0    壬寅 -.-     ---      -.-水坎[kǎn]       玄武
            "癸": [0, 2] //水 阴 东北方45   甲寅 ---     -.-少阳   -.-山艮[gèn]
        },
        /**
         * 24节气速查表
         */
    ...
    // function addressmatter(value,index){
    //     if(value!=null){
    //         if(value.length>6){
    ...
    function btnClick(options, e, count) {
        ...
        $(".days").click(function () {
            ...
            // $("#div_ClickDays").show();
            // $(".days").attr("title","adhgak");//.style.display='none';
