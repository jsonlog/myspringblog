...
insert into fest (timing, cal) values ('元旦节休', '2019-01-01');
...
insert into fest (timing, cal) values ('春节休', '2019-02-05');
...
insert into fest (timing, cal) values ('清明节休', '2019-04-05');
...
insert into fest (timing, cal) values ('劳动节休', '2019-05-01');
...
insert into fest (timing, cal) values ('端午节休', '2019-06-07');
insert into fest (timing, cal) values ('端午节休', '2019-06-08');
insert into fest (timing, cal) values ('端午节休', '2019-06-09');
insert into fest (timing, cal) values ('中秋节休', '2019-09-13');
...
insert into fest (timing, cal) values ('国庆节休', '2019-10-01');
